...
public class CreateItemStack {
    ...
    public static ItemStack createArmorItemStack(Rarity rarity, String name, Integer customModel, double armor, double toughness, ItemType itemType, ArrayList<String> description) {
        ItemStack itemStack;
        ItemMeta itemMeta;
